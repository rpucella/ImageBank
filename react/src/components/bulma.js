...
const ButtonDanger = styled.div.attrs({className: 'button is-danger'})``
...
export {Columns, ColumnOneThird, Column, Field, Control, Buttons, ButtonLink, ButtonDanger,
	Content, ButtonSmallLink, TagLink, TagSmallLink, Tag}

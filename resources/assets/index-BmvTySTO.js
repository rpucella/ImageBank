...
function R$2(a2, b2, e2, d2, c2) {
  ...
  if (h) return h = a2, c2 = c2(h), a2 = "" === d2 ? "." + Q$2(h, 0) : d2, I$2(c2) ? (e2 = "", null != a2 && (e2 = a2.replace(P$2, "$&/") + "/"), R$2(c2, b2, e2, "", function(a3) {
    return a3;
  })) : null != c2 && (O$3(c2) && (c2 = N$1(c2, e2 + (!c2.key || h && h.key === c2.key ? "" : ("" + c2.key).replace(P$2, "$&/") + "/") + a2)), b2.push(c2)), 1;
  h = 0;
  d2 = "" === d2 ? "." : d2 + ":";
...
var Fh = ua.ReactCurrentDispatcher, Gh = ua.ReactCurrentBatchConfig, Hh = 0, M$2 = null, N = null, O$2 = null, Ih = false, Jh = false, Kh = 0, Lh = 0;
function P$1() {
  throw Error(p$1(321));
}
function Mh(a2, b2) {
...
let U = false;
events = S, extensions = M, init = function(t2 = {}) {
  ...
  const menu = [
    {
      ...
      text: "Imagebank",
      menuItems: [
        { text: "About ImageBank" },
        { text: "-" },
        { text: "Quit ImageBank", shortcut: "q" }
      ]
    },
    {
      text: "Edit",

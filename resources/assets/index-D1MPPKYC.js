...
function oj(a2, b2, c2) {
  var d2 = b2.pendingProps, e2 = L$1.current, f2 = false, g2 = 0 !== (b2.flags & 128), h;
...
}(), Re = S, Te = { isServer: !S, useCSSOMInjection: !w$1 }, ke = function() {
...
}, dispatch: function(n2, r2, o2) {
  return new Promise((i2, s) => e(this, void 0, void 0, function* () {
    const e2 = yield t();
    if (e2.loaded.includes(n2)) if (e2.connected.includes(n2)) try {
      const e3 = yield f("extensions.dispatch", { extensionId: n2, event: r2, data: o2 });
      i2(e3);
    } catch (e3) {
      s(e3);
    }
    ...
    }(n2, { method: "extensions.dispatch", data: { extensionId: n2, event: r2, data: o2 }, resolve: i2, reject: s });
    else s({ code: "NE_EX_EXTNOTL", message: `${n2} is not loaded` });
  }));
}, getStats: t });
function r(e2, t2) {
...
function l() {
  ...
  const n2 = w().split(".")[1], s = window.NL_GINJECTED || window.NL_CINJECTED ? "127.0.0.1" : window.location.hostname;
  a = new WebSocket(`ws://${s}:${window.NL_PORT}?connectToken=${n2}`), function() {
    if (r("ready", () => e(this, void 0, void 0, function* () {
      if (yield p(u), !window.NL_EXTENABLED) return;
      const e2 = yield t();
      for (const t2 of e2.connected) o("extensionReady", t2);
    })), r("extClientConnect", (e2) => {
      o("extensionReady", e2.detail);
    }), !window.NL_EXTENABLED) return;
    r("extensionReady", (t2) => e(this, void 0, void 0, function* () {
    ...
    a.addEventListener("message", (e2) => {
      ...
      s2.id && s2.id in c ? ((null === (t2 = s2.data) || void 0 === t2 ? void 0 : t2.error) ? (c[s2.id].reject(s2.data.error), "NE_RT_INVTOKN" == s2.data.error.code && (a.close(), document.body.innerText = "", document.write("<code>NE_RT_INVTOKN</code>: Neutralinojs application cannot execute native methods since <code>NL_TOKEN</code> is invalid."))) : (null === (n3 = s2.data) || void 0 === n3 ? void 0 : n3.success) && c[s2.id].resolve(s2.data.hasOwnProperty("returnValue") ? s2.data.returnValue : s2.data), delete c[s2.id]) : s2.event && ("openedFile" == s2.event && "dataBinary" == (null === (r2 = null == s2 ? void 0 : s2.data) || void 0 === r2 ? void 0 : r2.action) && (s2.data.data = i(s2.data.data)), o(s2.event, s2.data));
    }), a.addEventListener("open", (t2) => e(this, void 0, void 0, function* () {
      o("ready");
    })), a.addEventListener("close", (t2) => e(this, void 0, void 0, function* () {
      o("serverOffline", { code: "NE_CL_NSEROFF", message: "Neutralino server is offline. Try restarting the application" });
...
function f(e2, t2) {
  return new Promise((n2, r2) => {
    if ((null == a ? void 0 : a.readyState) != WebSocket.OPEN) return o2 = { method: e2, data: t2, resolve: n2, reject: r2 }, void u.push(o2);
    var o2;
    const i2 = "10000000-1000-4000-8000-100000000000".replace(/[018]/g, (e3) => (e3 ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> e3 / 4).toString(16)), s = w();
    c[i2] = { resolve: n2, reject: r2 }, a.send(JSON.stringify({ id: i2, method: e2, data: t2, accessToken: s }));
  });
}
function p(t2) {
...
var D = Object.freeze({ __proto__: null, broadcast: function(e2, t2) {
  return f("events.broadcast", { event: e2, data: t2 });
}, dispatch: o, off: function(e2, t2) {
  return window.removeEventListener(e2, t2), Promise.resolve({ success: true, message: "Event listener removed" });
}, on: r });
let M = false;
events = D, extensions = n, init = function(t2 = {}) {
  if (t2 = Object.assign({ exportCustomMethods: true }, t2), !M) {
    if (l(), window.NL_ARGS.find((e2) => "--neu-dev-auto-reload" == e2) && r("neuDev_reloadApp", () => e(this, void 0, void 0, function* () {
      yield b("Reloading the application..."), location.reload();
      ...
      let n2 = {};
      for (const [e3, r2] of t3.entries()) n2 = "object" != typeof r2 || Array.isArray(r2) || null == r2 ? Object.assign(Object.assign({}, n2), { ["arg" + e3]: r2 }) : Object.assign(Object.assign({}, n2), r2);
      return f("custom." + e2, n2);
    };
    window.NL_CVERSION = "5.6.0", window.NL_CCOMMIT = "425c526c318342e0e5d0f17caceef2a53049eda4", M = true;
  }
};

...
function R$2(a2, b2, e2, d2, c2) {
  ...
  if (h) return h = a2, c2 = c2(h), a2 = "" === d2 ? "." + Q$2(h, 0) : d2, I$2(c2) ? (e2 = "", null != a2 && (e2 = a2.replace(P$1, "$&/") + "/"), R$2(c2, b2, e2, "", function(a3) {
    return a3;
  })) : null != c2 && (O$2(c2) && (c2 = N$1(c2, e2 + (!c2.key || h && h.key === c2.key ? "" : ("" + c2.key).replace(P$1, "$&/") + "/") + a2)), b2.push(c2)), 1;
  h = 0;
  d2 = "" === d2 ? "." : d2 + ":";
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$2 = reactExports, k$1 = Symbol.for("react.element"), l$1 = Symbol.for("react.fragment"), m$2 = Object.prototype.hasOwnProperty, n$1 = f$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$1 = { key: true, ref: true, __self: true, __source: true };
...
function bg(a2, b2, c2) {
  ...
  for (var e2 in d2) if (!(e2 in b2)) throw Error(p(108, Ra(a2) || "Unknown", e2));
  return A$1({}, c2, d2);
}
function cg(a2) {
...
function rj(a2, b2, c2, d2, e2, f2, g2) {
  if (c2) {
    if (b2.flags & 256) return b2.flags &= -257, d2 = Ki(Error(p(422))), sj(a2, b2, g2, d2);
        ...
        if (Gg(b2)) {
          ...
          for (var g2 in f2) if (f2.hasOwnProperty(g2)) {
            ...
            "children" === g2 ? "string" === typeof h ? d2.textContent !== h && (true !== f2.suppressHydrationWarning && Af(d2.textContent, h, a2), e2 = ["children", h]) : "number" === typeof h && d2.textContent !== "" + h && (true !== f2.suppressHydrationWarning && Af(
              ...
              h,
              a2
            ), e2 = ["children", "" + h]) : ea.hasOwnProperty(g2) && null != h && "onScroll" === g2 && D$1("scroll", d2);
          }
          switch (c2) {
            case "input":
              Va(d2);
...
function u() {
  ...
  const r2 = f().split(".")[1], o = window.NL_GINJECTED || window.NL_CINJECTED ? "127.0.0.1" : window.location.hostname;
  i = new WebSocket(`ws://${o}:${window.NL_PORT}?connectToken=${r2}`), function() {
    if (e("ready", async () => {
...
function d(e2, t2) {
  return new Promise((n2, r2) => {
    if ((i == null ? void 0 : i.readyState) != WebSocket.OPEN) return o = { method: e2, data: t2, resolve: n2, reject: r2 }, void s.push(o);
    var o;
...
var M = Object.freeze({ __proto__: null, broadcast: function(e2, t2) {
  ...
  return new Promise(async (r2, o) => {
    ...
    }(e2, { method: "extensions.dispatch", data: { extensionId: e2, event: t2, data: n2 }, resolve: r2, reject: o });
    else o({ code: "NE_EX_EXTNOTL", message: `${e2} is not loaded` });
  });
}, getStats: L });
let U = false;

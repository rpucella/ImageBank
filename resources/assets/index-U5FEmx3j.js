...
function M$3(a2, b2, e2) {
  ...
  if (null != b2) for (d2 in void 0 !== b2.ref && (h = b2.ref), void 0 !== b2.key && (k2 = "" + b2.key), b2) J$1.call(b2, d2) && !L$3.hasOwnProperty(d2) && (c2[d2] = b2[d2]);
  ...
  return { $$typeof: l$2, type: a2, key: k2, ref: h, props: c2, _owner: K$2.current };
}
function N$2(a2, b2) {
...
function R$2(a2, b2, e2, d2, c2) {
  ...
  if (h) return h = a2, c2 = c2(h), a2 = "" === d2 ? "." + Q$2(h, 0) : d2, I$2(c2) ? (e2 = "", null != a2 && (e2 = a2.replace(P$2, "$&/") + "/"), R$2(c2, b2, e2, "", function(a3) {
    return a3;
  })) : null != c2 && (O$3(c2) && (c2 = N$2(c2, e2 + (!c2.key || h && h.key === c2.key ? "" : ("" + c2.key).replace(P$2, "$&/") + "/") + a2)), b2.push(c2)), 1;
  h = 0;
  d2 = "" === d2 ? "." : d2 + ":";
  ...
  else if (f2 = A$2(a2), "function" === typeof f2) for (a2 = f2.call(a2), g2 = 0; !(k2 = a2.next()).done; ) k2 = k2.value, f2 = d2 + Q$2(k2, g2++), h += R$2(k2, b2, e2, f2, c2);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$2 = reactExports, k$1 = Symbol.for("react.element"), l$1 = Symbol.for("react.fragment"), m$2 = Object.prototype.hasOwnProperty, n$1 = f$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$2 = { key: true, ref: true, __self: true, __source: true };
function q$1(c2, a2, g2) {
  ...
  return { $$typeof: k$1, type: c2, key: e2, ref: h, props: d2, _owner: n$1.current };
}
...
(function(exports$1) {
  ...
  exports$1.unstable_scheduleCallback = function(a2, b2, c2) {
    ...
    c2 > d2 ? (a2.sortIndex = c2, f2(t2, a2), null === h(r2) && a2 === h(t2) && (B2 ? (E2(L2), L2 = -1) : B2 = true, K2(H2, c2 - d2))) : (a2.sortIndex = e2, f2(r2, a2), A2 || z2 || (A2 = true, I2(J2)));
    return a2;
  };
...
function wc(a2, b2) {
  for (var c2 = a2.suspendedLanes, d2 = a2.pingedLanes, e2 = a2.expirationTimes, f2 = a2.pendingLanes; 0 < f2; ) {
    ...
    if (-1 === k2) {
      if (0 === (h & c2) || 0 !== (h & d2)) e2[g2] = vc(h, b2);
...
function wf(a2, b2, c2, d2, e2) {
  for (var f2 = b2._reactName, g2 = []; null !== c2 && c2 !== d2; ) {
    ...
    5 === h.tag && null !== l2 && (h = l2, e2 ? (k2 = Kb(c2, f2), null != k2 && g2.unshift(tf(c2, k2, h))) : e2 || (k2 = Kb(c2, f2), null != k2 && g2.push(tf(c2, k2, h))));
    c2 = c2.return;
  }
...
function Og(a2) {
  ...
  function r2(a3, b3, c3, d3) {
    ...
    if ("string" === typeof c3 && "" !== c3 || "number" === typeof c3) return null !== e3 ? null : h(a3, b3, "" + c3, d3);
  ...
  function y2(a3, b3, c3, d3, e3) {
    if ("string" === typeof d3 && "" !== d3 || "number" === typeof d3) return a3 = a3.get(c3) || null, h(b3, a3, "" + d3, e3);
  ...
  function n2(e3, g3, h2, k3) {
    ...
    if (w2 === h2.length) return c2(e3, u2), I$1 && tg(e3, w2), l3;
    if (null === u2) {
      for (; w2 < h2.length; w2++) u2 = q2(e3, h2[w2], k3), null !== u2 && (g3 = f2(u2, g3, w2), null === m3 ? l3 = u2 : m3.sibling = u2, m3 = u2);
      I$1 && tg(e3, w2);
      return l3;
    }
    for (u2 = d2(e3, u2); w2 < h2.length; w2++) x2 = y2(u2, e3, w2, h2[w2], k3), null !== x2 && (a2 && null !== x2.alternate && u2.delete(null === x2.key ? w2 : x2.key), g3 = f2(x2, g3, w2), null === m3 ? l3 = x2 : m3.sibling = x2, m3 = x2);
  ...
  function t2(e3, g3, h2, k3) {
    ...
    if (null === m3) {
      for (; !n3.done; w2++, n3 = h2.next()) n3 = q2(e3, n3.value, k3), null !== n3 && (g3 = f2(n3, g3, w2), null === u2 ? l3 = n3 : u2.sibling = n3, u2 = n3);
      I$1 && tg(e3, w2);
      return l3;
    }
    for (m3 = d2(e3, m3); !n3.done; w2++, n3 = h2.next()) n3 = y2(m3, e3, w2, n3.value, k3), null !== n3 && (a2 && null !== n3.alternate && m3.delete(null === n3.key ? w2 : n3.key), g3 = f2(n3, g3, w2), null === u2 ? l3 = n3 : u2.sibling = n3, u2 = n3);
  ...
  function J2(a3, d3, f3, h2) {
    ...
    return "string" === typeof f3 && "" !== f3 || "number" === typeof f3 ? (f3 = "" + f3, null !== d3 && 6 === d3.tag ? (c2(a3, d3.sibling), d3 = e2(d3, f3), d3.return = a3, a3 = d3) : (c2(a3, d3), d3 = Qg(f3, a3.mode, h2), d3.return = a3, a3 = d3), g2(a3)) : c2(a3, d3);
  }
  return J2;
}
...
function hj(a2, b2, c2, d2, e2) {
  ...
  if (null === b2.stateNode) ij(a2, b2), Gi(b2, c2, d2), Ii(b2, c2, d2, e2), d2 = true;
    ...
    q2 || "function" !== typeof g2.UNSAFE_componentWillReceiveProps && "function" !== typeof g2.componentWillReceiveProps || (h !== d2 || k2 !== l2) && Hi(b2, g2, d2, l2);
    jh = false;
    var r2 = b2.memoizedState;
    g2.state = r2;
    qh(b2, d2, g2, e2);
    k2 = b2.memoizedState;
    h !== d2 || r2 !== k2 || Wf.current || jh ? ("function" === typeof m2 && (Di(b2, c2, m2, d2), k2 = b2.memoizedState), (h = jh || Fi(b2, c2, h, d2, r2, k2, l2)) ? (q2 || "function" !== typeof g2.UNSAFE_componentWillMount && "function" !== typeof g2.componentWillMount || ("function" === typeof g2.componentWillMount && g2.componentWillMount(), "function" === typeof g2.UNSAFE_componentWillMount && g2.UNSAFE_componentWillMount()), "function" === typeof g2.componentDidMount && (b2.flags |= 4194308)) : ("function" === typeof g2.componentDidMount && (b2.flags |= 4194308), b2.memoizedProps = d2, b2.memoizedState = k2), g2.props = d2, g2.state = k2, g2.context = l2, d2 = h) : ("function" === typeof g2.componentDidMount && (b2.flags |= 4194308), d2 = false);
  } else {
    g2 = b2.stateNode;
    lh(a2, b2);
    h = b2.memoizedProps;
    ...
    (m2 = "function" === typeof y2 || "function" === typeof g2.getSnapshotBeforeUpdate) || "function" !== typeof g2.UNSAFE_componentWillReceiveProps && "function" !== typeof g2.componentWillReceiveProps || (h !== q2 || r2 !== k2) && Hi(b2, g2, d2, k2);
    jh = false;
    r2 = b2.memoizedState;
    g2.state = r2;
    qh(b2, d2, g2, e2);
    var n2 = b2.memoizedState;
    h !== q2 || r2 !== n2 || Wf.current || jh ? ("function" === typeof y2 && (Di(b2, c2, y2, d2), n2 = b2.memoizedState), (l2 = jh || Fi(b2, c2, l2, d2, r2, n2, k2) || false) ? (m2 || "function" !== typeof g2.UNSAFE_componentWillUpdate && "function" !== typeof g2.componentWillUpdate || ("function" === typeof g2.componentWillUpdate && g2.componentWillUpdate(d2, n2, k2), "function" === typeof g2.UNSAFE_componentWillUpdate && g2.UNSAFE_componentWillUpdate(d2, n2, k2)), "function" === typeof g2.componentDidUpdate && (b2.flags |= 4), "function" === typeof g2.getSnapshotBeforeUpdate && (b2.flags |= 1024)) : ("function" !== typeof g2.componentDidUpdate || h === a2.memoizedProps && r2 === a2.memoizedState || (b2.flags |= 4), "function" !== typeof g2.getSnapshotBeforeUpdate || h === a2.memoizedProps && r2 === a2.memoizedState || (b2.flags |= 1024), b2.memoizedProps = d2, b2.memoizedState = n2), g2.props = d2, g2.state = n2, g2.context = k2, d2 = l2) : ("function" !== typeof g2.componentDidUpdate || h === a2.memoizedProps && r2 === a2.memoizedState || (b2.flags |= 4), "function" !== typeof g2.getSnapshotBeforeUpdate || h === a2.memoizedProps && r2 === a2.memoizedState || (b2.flags |= 1024), d2 = false);
  }
...
function jj(a2, b2, c2, d2, e2, f2) {
  ...
  b2.flags |= 1;
  null !== a2 && g2 ? (b2.child = Ug(b2, a2.child, null, f2), b2.child = Ug(b2, null, h, f2)) : Xi(a2, b2, h, f2);
...
function oj(a2, b2, c2) {
  var d2 = b2.pendingProps, e2 = L$2.current, f2 = false, g2 = 0 !== (b2.flags & 128), h;
  (h = g2) || (h = null !== a2 && null === a2.memoizedState ? false : 0 !== (e2 & 2));
  ...
  e2 = a2.memoizedState;
  if (null !== e2 && (h = e2.dehydrated, null !== h)) return rj(a2, b2, g2, d2, h, e2, c2);
  if (f2) {
    f2 = d2.fallback;
    g2 = b2.mode;
    e2 = a2.child;
      ...
      if (null !== a2 && null != b2.stateNode) Bj(a2, b2, c2, d2, e2), a2.ref !== b2.ref && (b2.flags |= 512, b2.flags |= 2097152);
        ...
        if (Gg(b2)) {
          ...
          for (var g2 in f2) if (f2.hasOwnProperty(g2)) {
            var h = f2[g2];
            "children" === g2 ? "string" === typeof h ? d2.textContent !== h && (true !== f2.suppressHydrationWarning && Af(d2.textContent, h, a2), e2 = ["children", h]) : "number" === typeof h && d2.textContent !== "" + h && (true !== f2.suppressHydrationWarning && Af(
              d2.textContent,
              h,
              a2
            ), e2 = ["children", "" + h]) : ea.hasOwnProperty(g2) && null != h && "onScroll" === g2 && D$2("scroll", d2);
          }
          switch (c2) {
            case "input":
              Va(d2);
    ...
    case 19:
      ...
      if (null === g2) if (d2) Dj(f2, false);
        ...
        if (!d2) if (a2 = Ch(g2), null !== a2) {
          if (b2.flags |= 128, d2 = true, c2 = a2.updateQueue, null !== c2 && (b2.updateQueue = c2, b2.flags |= 4), Dj(f2, true), null === f2.tail && "hidden" === f2.tailMode && !g2.alternate && !I$1) return S$2(b2), null;
        } else 2 * B$1() - f2.renderingStartTime > Gj && 1073741824 !== c2 && (b2.flags |= 128, d2 = true, Dj(f2, false), b2.lanes = 4194304);
        f2.isBackwards ? (g2.sibling = b2.child, b2.child = g2) : (c2 = f2.last, null !== c2 ? c2.sibling = g2 : b2.child = g2, f2.last = g2);
      }
      if (null !== f2.tail) return b2 = f2.tail, f2.rendering = b2, f2.tail = b2.sibling, f2.renderingStartTime = B$1(), b2.sibling = null, c2 = L$2.current, G$1(L$2, d2 ? c2 & 1 | 2 : c2 & 1), b2;
      S$2(b2);
      return null;
    case 22:
    case 23:
  ...
  if (Ne$1(a2)) {
    if ("selectionStart" in a2) var c2 = { start: a2.selectionStart, end: a2.selectionEnd };
      ...
      if (d2 && 0 !== d2.rangeCount) {
        ...
        b: for (; ; ) {
          for (var y2; ; ) {
            q2 !== c2 || 0 !== e2 && 3 !== q2.nodeType || (h = g2 + e2);
        ...
        a: for (m2 = null, q2 = a2; ; ) {
          if (5 === q2.tag) {
            if (null === m2) {
              m2 = q2;
              try {
                e2 = q2.stateNode, l2 ? (f2 = e2.style, "function" === typeof f2.setProperty ? f2.setProperty("display", "none", "important") : f2.display = "none") : (h = q2.stateNode, k2 = q2.memoizedProps.style, g2 = void 0 !== k2 && null !== k2 && k2.hasOwnProperty("display") ? k2.display : null, h.style.display = rb("display", g2));
              } catch (t2) {
                W$1(a2, a2.return, t2);
              }
            }
  ...
  for (var d2 = 0 !== (a2.mode & 1); null !== V$1; ) {
    ...
    if (22 === e2.tag && d2) {
      ...
      if (!g2) {
        ...
        var l2 = U$2;
        Jj = g2;
        if ((U$2 = k2) && !l2) for (V$1 = e2; null !== V$1; ) g2 = V$1, k2 = g2.child, 22 === g2.tag && null !== g2.memoizedState ? jk(e2) : null !== k2 ? (k2.return = g2, V$1 = k2) : jk(e2);
...
var lk = Math.ceil, mk = ua.ReactCurrentDispatcher, nk = ua.ReactCurrentOwner, ok = ua.ReactCurrentBatchConfig, K$1 = 0, Q$1 = null, Y$1 = null, Z$1 = 0, fj = 0, ej = Uf(0), T$2 = 0, pk = null, rh = 0, qk = 0, rk = 0, sk = null, tk = null, fk = 0, Gj = Infinity, uk = null, Oi = false, Pi = null, Ri = null, vk = false, wk = null, xk = 0, yk = 0, zk = null, Ak = -1, Bk = 0;
function R$1() {
...
function gi(a2, b2, c2, d2) {
  ...
  Ac(a2, c2, d2);
  if (0 === (K$1 & 2) || a2 !== Q$1) a2 === Q$1 && (0 === (K$1 & 2) && (qk |= c2), 4 === T$2 && Ck(a2, Z$1)), Dk(a2, d2), 1 === c2 && 0 === K$1 && 0 === (b2.mode & 1) && (Gj = B$1() + 500, fg && jg());
}
function Dk(a2, b2) {
...
function Gk(a2, b2) {
  ...
  if (0 !== (d2 & 30) || 0 !== (d2 & a2.expiredLanes) || b2) b2 = Ik(a2, d2);
    ...
    mk.current = f2;
    K$1 = e2;
    null !== Y$1 ? b2 = 0 : (Q$1 = null, Z$1 = 0, b2 = T$2);
  }
  if (0 !== b2) {
...
function Ti(a2, b2, c2) {
  ...
  Q$1 === a2 && (Z$1 & c2) === c2 && (4 === T$2 || 3 === T$2 && (Z$1 & 130023424) === Z$1 && 500 > B$1() - fk ? Kk(a2, 0) : rk |= c2);
  Dk(a2, b2);
}
function Yk(a2, b2) {
...
function bl(a2, b2, c2, d2, e2, f2, g2, h, k2) {
...
function el(a2, b2, c2, d2, e2, f2, g2, h, k2) {
  a2 = bl(c2, d2, true, a2, e2, f2, g2, h, k2);
  a2.context = dl(null);
  c2 = a2.current;
  d2 = R$1();
  e2 = yi(c2);
...
var f$1 = "undefined" != typeof process && void 0 !== define_process_env_default && (define_process_env_default.REACT_APP_SC_ATTR || define_process_env_default.SC_ATTR) || "data-styled", m = "active", y = "data-styled-version", v = "6.1.19", g = "/*!sc*/\n", S$1 = "undefined" != typeof window && "undefined" != typeof document, w = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== define_process_env_default && void 0 !== define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY && "" !== define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY ? "false" !== define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY && define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== define_process_env_default && void 0 !== define_process_env_default.SC_DISABLE_SPEEDY && "" !== define_process_env_default.SC_DISABLE_SPEEDY ? "false" !== define_process_env_default.SC_DISABLE_SPEEDY && define_process_env_default.SC_DISABLE_SPEEDY : false), b$1 = {}, _$1 = Object.freeze([]), C = Object.freeze({});
function I(e2, t2, n2) {
...
var T$1 = /(a)(d)/gi, k = 52, j = function(e2) {
  return String.fromCharCode(e2 + (e2 > 25 ? 39 : 97));
};
function x$1(e2) {
  var t2, n2 = "";
  for (t2 = Math.abs(e2); t2 > k; t2 = t2 / k | 0) n2 = j(t2 % k) + n2;
  return (j(t2 % k) + n2).replace(T$1, "$1-$2");
}
...
var fe = function() {
...
}, be = "style[".concat(f$1, "][").concat(y, '="').concat(v, '"]'), Ee = new RegExp("^".concat(f$1, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), Ne = function(e2, t2, n2) {
  ...
  for (var t2 = document.querySelectorAll(be), n2 = 0, o2 = t2.length; n2 < o2; n2++) {
    var r2 = t2[n2];
    r2 && r2.getAttribute(f$1) !== m && (Pe(e2, r2), r2.parentNode && r2.parentNode.removeChild(r2));
  }
};
function Ce() {
...
var Ie = function(e2) {
  ...
  o2.setAttribute(f$1, m), o2.setAttribute(y, v);
  var i2 = Ce();
...
function Fe(e2) {
  var t2, n2, o2, r2 = C, s2 = r2.options, i2 = void 0 === s2 ? C : s2, a2 = r2.plugins, c2 = void 0 === a2 ? _$1 : a2, l2 = function(e3, o3, r3) {
...
var Ke = z(v), Qe = function() {
  ...
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.isStatic && !n2.hash) if (this.staticRulesId && t2.hasNameForId(this.componentId, this.staticRulesId)) o2 = ie(o2, this.staticRulesId);
      ...
      var r2 = ae(Xe(this.rules, e3, t2, n2)), s2 = x$1(M$1(this.baseHash, r2) >>> 0);
...
function it(e2, r2, s2) {
  ...
  function O2(e3, r3) {
    return function(e4, r4, s3) {
      ...
      var N3 = ie(p3, d3);
      return E3 && (N3 += " " + E3), g3.className && (N3 += " " + g3.className), w3[L$1(S3) && !A.has(S3) ? "class" : "className"] = N3, s3 && (w3.ref = s3), reactExports.createElement(S3, w3);
    }(D2, e3, r3);
  }
  O2.displayName = y2;
...
const PageContext = reactExports.createContext([{ type: "published", page: 1, url: "/" }, () => {
}]);
const usePageContext = () => {
  const [page, setPage] = reactExports.useContext(PageContext);
  return [page, setPage];
};
...
class Api {
  ...
  async postImageEdit(uuid, text, tags) {
    return await this.call("post-edit", { uid: uuid, text, tags: tags.join(" ;; ") });
  }
...
const addSVG = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='utf-8'?%3e%3c!--%20Svg%20Vector%20Icons%20:%20http://www.onlinewebfonts.com/icon%20--%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%201.1//EN'%20'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'%3e%3csvg%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%20x='0px'%20y='0px'%20height='1000'%20width='1000'%20viewBox='0%200%201000%201000'%20enable-background='new%200%200%201000%201000'%20xml:space='preserve'%3e%3cg%3e%3cpath%20d='M500,10C229.4,10,10,229.4,10,500c0,270.6,219.4,490,490,490c270.6,0,490-219.4,490-490C990,229.4,770.6,10,500,10z%20M500,867.5c-203,0-367.5-164.6-367.5-367.5c0-203,164.6-367.5,367.5-367.5C703,132.5,867.5,297,867.5,500C867.5,702.9,703,867.5,500,867.5z'/%3e%3cpath%20d='M714.4,438.8H561.3V285.6c0-16.9-13.7-30.6-30.6-30.6h-61.3c-16.9,0-30.6,13.7-30.6,30.6v153.1H285.6c-16.9,0-30.6,13.7-30.6,30.6v61.3c0,16.9,13.7,30.6,30.6,30.6h153.1v153.1c0,16.9,13.7,30.6,30.6,30.6h61.3c16.9,0,30.6-13.7,30.6-30.6V561.3h153.1c16.9,0,30.6-13.7,30.6-30.6v-61.3C745,452.4,731.3,438.8,714.4,438.8z'/%3e%3c/g%3e%3c/svg%3e";
const Logo = dt.span`
  font-weight: bold;
  font-size: 150%;
...
const Header = () => {
  ...
  const [_2, setPage] = usePageContext();
  const go = (obj) => () => {
    setPage(obj);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar is-tablet", role: "navigation", "aria-label": "main navigation", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "navbar-brand", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { className: "navbar-item", onClick: go({ type: "published", page: 1, url: "/" }), children: "ImageBank" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { role: "button", className: showMenu ? "navbar-burger is-active" : "navbar-burger", "aria-label": "menu", "aria-expanded": "false", "data-target": "navbarMenu", onClick: toggleMenu, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "navbarMenu", className: showMenu ? "navbar-menu is-active" : "navbar-menu", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "navbar-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "navbar-item", onClick: go({ type: "published", page: 1, url: "/" }), children: "Completed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "navbar-item", onClick: go({ type: "draft", page: 1, url: "/" }), children: "Drafts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "navbar-item", onClick: go({ type: "new", page: 1, url: "/" }), children: "Bank" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "navbar-item", onClick: go({ type: "tags", url: "/" }), children: "Tags" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "navbar-item", onClick: go({ type: "add", url: "/" }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: addSVG, height: "12", width: "12" }),
        " Image"
      ] }) })
    ] }) })
  ] });
};
const ScreenLayout = dt.div`
  margin: 16px 40px;
  display: flex;
  flex-direction: row;
`;
const Column$1 = dt.div`
  display: flex;
  margin: 0 auto;
...
const Title = dt.div`
  ...
  margin-bottom: 16px;
`;
const Screen = ({ setPage, title, pageTitle, children }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { setPage }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScreenLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Column$1, { children: [
      title && /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { children: title }),
      children
    ] }) })
  ] }) });
};
const Columns = dt.div.attrs({ className: "columns" })``;
const ColumnOneThird = dt.div.attrs({ className: "column is-one-third" })``;
const Column = dt.div.attrs({ className: "column" })``;
const Field = dt.div.attrs({ className: "field" })``;
const Control = dt.div.attrs({ className: "control" })``;
const Buttons = dt.div.attrs({ className: "buttons" })``;
const ButtonLink = dt.div.attrs({ className: "button is-link" })``;
dt.div.attrs({ className: "button is-danger" })``;
const Content = dt.div.attrs({ className: "content" })``;
const ButtonSmallLink = dt.div.attrs({ className: "button is-small is-link" })``;
const ButtonSmallDanger = dt.div.attrs({ className: "button is-small is-danger" })``;
const TagLink = dt.div.attrs({ className: "button is-rounded is-link is-light" })``;
const TagSmallLink = dt.div.attrs({ className: "button is-rounded is-link is-light is-small" })``;
const Tag = dt.div.attrs({ className: "button is-static is-rounded is-light" })``;
...
function AddPage() {
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  const inputEl = reactExports.useRef(null);
  const urlEl = reactExports.useRef(null);
  const clickSave = async () => {
    ...
    if (files.length === 1) {
      ...
      const { uid } = await Api2.postImageAdd(fileObj);
      setPage({ type: "image", uuid: uid, url: "/" });
    } else {
      for (let i2 = 0; i2 < files.length; i2++) {
        const fileObj = await convertBase64(files[i2]);
        await Api2.postImageAdd(fileObj);
      }
  ...
  const clickSaveURL = async () => {
    ...
    const { uid } = await Api2.postImageAddURL(url);
    setPage({ type: "image", uuid: uid, url: "/" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Screen, { title: "Add Image", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", type: "file", placeholder: "File", ref: inputEl, multiple: true }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonLink, { onClick: clickSave, children: " Load " }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { style: { marginTop: "2rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", type: "text", placeholder: "URL", ref: urlEl }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonLink, { onClick: clickSaveURL, children: " Load URL " }) }) })
  ] });
}
function useEventListener(eventName, handler, element) {
  ...
  reactExports.useEffect(
    () => {
      const newElement = window;
      const isSupported = newElement && newElement.addEventListener;
      if (!isSupported) return;
      const eventListener = (event2) => savedHandler.current(event2);
...
const useImage = (img) => {
  ...
  reactExports.useEffect(() => {
    (async () => {
      const data2 = await Api2.getImage(img.uuid);
      setData(data2.image);
    })();
  }, [img]);
  return data;
...
function formatDate(dstr) {
  if (dstr) {
    ...
    const dt2 = `${d2.getFullYear()}-${pad2(d2.getMonth() + 1)}-${pad2(d2.getDate())}`;
    const tm = `${pad2(d2.getHours())}:${pad2(d2.getMinutes())}:${pad2(d2.getSeconds())}`;
    return dt2 + " (" + tm + ")";
  } else {
    return "";
  }
}
const LinkImg$1 = dt.img`
  cursor: pointer;
`;
const Dates = dt.div`
  margin-top: 32px;
  ...
  flex-direction: column;
`;
const DateLineLayout = dt.div`
  display: flex;
  flex-direction: row;
  justify-content: flex-end;
`;
const DateItem = dt.div`
  margin-left: 8px;
  width: 10em;
`;
const TextItem = dt.div`
  margin: 0 8px;
`;
const DateLine = ({ text, date }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DateLineLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(TextItem, { children: [
      text,
      ":"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DateItem, { children: formatDate(date) })
  ] });
};
const Image = ({ img, extended }) => {
  const image = useImage(img);
  const [draft, setDraft] = reactExports.useState(img.draft);
  ...
  const deleteImage = async () => {
    ...
    await Api2.postImageDelete(img.uuid);
    setPage({ type: "published", page: 1, url: "/" });
  };
  const clickPublish = async () => {
    await Api2.postImagePublish(img.uuid);
    setDraft(false);
  };
  const clickDraft = async () => {
    await Api2.postImageDraft(img.uuid);
    setDraft(true);
  };
  if (!image) {
    return null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Columns, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Column, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { children: [
        img.content.map((line2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: line2 }, line2 + i2)),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Buttons, { children: [
          extended && /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "button is-small is-link", id: "button-edit", onClick: () => setPage({ type: "edit", image: img, url: "/" }), children: "Edit" }),
          extended && draft && /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonSmallLink, { onClick: clickPublish, children: " Publish " }),
          extended && !draft && /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonSmallLink, { onClick: clickDraft, children: " Draft " }),
          extended && draft && /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonSmallDanger, { onClick: deleteDialog, children: " Delete " }),
          img.tags.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TagSmallLink, { onClick: () => setPage({ type: "tag", tag: t2, page: 1, url: "/" }), children: [
            " ",
            t2,
            " "
          ] }, t2))
        ] }) }) }),
        extended && /* @__PURE__ */ jsxRuntimeExports.jsxs(Dates, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DateLine, { text: "Created", date: img.date_created }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DateLine, { text: "Updated", date: img.date_updated }),
          img.date_published && /* @__PURE__ */ jsxRuntimeExports.jsx(DateLine, { text: "Published", date: img.date_published })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: confirmDelete ? "modal is-active" : "modal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-background", onClick: () => setConfirmDelete(false) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "box", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Delete image?" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field is-grouped mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button is-link", onClick: deleteImage, children: "OK" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button is-light", onClick: () => setConfirmDelete(false), children: "Cancel" }) })
        ] })
      ] }) })
    ] })
  ] });
};
function ImagePage({ uuid }) {
  const [imageData, setImageData] = reactExports.useState(null);
  const goPrevious = reactExports.useRef(null);
  const goNext = reactExports.useRef(null);
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  const keyHandler = ({ key }) => {
    var _a, _b;
    if (key == "ArrowRight" && ((_a = goPrevious.current) == null ? void 0 : _a.uuid)) {
      setPage({ type: "image", uuid: goPrevious.current.uuid, url: "/" });
    } else if (key == "ArrowLeft" && ((_b = goNext.current) == null ? void 0 : _b.uuid)) {
  ...
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getImageData(uuid);
      setImageData(data);
    })();
  }, [uuid]);
  if (!imageData) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Screen, { pageTitle: "Image", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "pagination", role: "navigation", "aria-label": "pagination", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "pagination-previous", disabled: !imagePreviousOK, onClick: go(imagePrevious), children: " Previous" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "pagination-next", disabled: !imageNextOK, onClick: go(imageNext), children: "Next" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { img: image, extended: true }, image.uuid)
  ] });
}
const Layout = dt.div`
  flex: 0 0 25%;
...
const Link = dt.div`
  cursor: pointer;
`;
const Pager = ({ page, total, setPage }) => total > 10 ? /* @__PURE__ */ jsxRuntimeExports.jsx(FullPager, { page, total, setPage }) : /* @__PURE__ */ jsxRuntimeExports.jsx(PartialPager, { page, total, setPage });
const FullPager = ({ page, total, setPage }) => {
  const start = page - 3 > 1 ? page - 3 : 1;
  const end = page + 3 < total ? page + 3 : total;
  const switchTo = (p2) => () => setPage(p2);
  const prevEnabled = page > 1;
  const nextEnabled = page < total;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "pagination", role: "navigation", "aria-label": "pagination", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "pagination-previous", onClick: prevEnabled ? switchTo(page - 1) : void 0, disabled: !prevEnabled, children: " Previous " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "pagination-next", onClick: nextEnabled ? switchTo(page + 1) : void 0, disabled: !nextEnabled, children: " Next " }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "pagination-list", children: [
      page > 4 && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "pagination-link", onClick: switchTo(1), children: " 1 " }) }),
      page > 5 && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pagination-ellipsis", children: "…" }) }),
      Array.from(new Array(end - start + 1)).map((_2, i2) => {
        const p2 = i2 + start;
        const cls = "pagination-link" + (p2 === page ? " is-current" : "");
        return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { className: cls, onClick: switchTo(p2), children: [
          " ",
          p2,
          " "
        ] }) }, "page" + p2);
      }),
      page < total - 4 && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pagination-ellipsis", children: "…" }) }),
      page < total - 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { className: "pagination-link", onClick: switchTo(total), children: [
        " ",
        total,
        " "
      ] }) })
...
const PartialPager = ({ page, total, setPage }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "pagination", role: "navigation", "aria-label": "pagination", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "pagination-previous", onClick: prevEnabled ? switchTo(page - 1) : void 0, disabled: !prevEnabled, children: " Previous " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "pagination-next", onClick: nextEnabled ? switchTo(page + 1) : void 0, disabled: !nextEnabled, children: " Next " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "pagination-list", children: Array.from(new Array(total)).map((_2, i2) => {
      const p2 = i2 + 1;
      const cls = "pagination-link" + (p2 === page ? " is-current" : "");
      return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { className: cls, onClick: switchTo(p2), children: [
        " ",
...
function NewPage({ page }) {
  const [newData, setNewData] = reactExports.useState(null);
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getNewData(page);
      setNewData(data);
    })();
  }, [page]);
  if (!newData) {
  ...
  const go = (p2) => {
    setPage({ type: "new", page: p2, url: "/" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Screen, { title: "Image Bank", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Board, { children: images.map((img) => /* @__PURE__ */ jsxRuntimeExports.jsx(Thumbnail, { img }, img.uuid)) })
  ] });
}
function DraftPage({ page }) {
  const [draftData, setDraftData] = reactExports.useState(null);
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getDraftData(page);
      setDraftData(data);
    })();
  }, [page]);
  if (!draftData) {
  ...
  const go = (p2) => {
    setPage({ type: "draft", page: p2, url: "/" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Screen, { title: "Drafts", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total }),
    images.map((img) => /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { img }, img.uuid)),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total })
  ] });
}
function PublishedPage({ page }) {
  const [publishedData, setPublishedData] = reactExports.useState(null);
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getPublishedData(page);
  ...
  const go = (p2) => {
    setPage({ type: "published", page: p2, url: "/" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Screen, { title: "Completed", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total }),
    images.map((img) => /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { img }, img.uuid)),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total })
  ] });
}
function TagPage({ tag, page }) {
  const [tagData, setTagData] = reactExports.useState(null);
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getTagData(tag, page);
      setTagData(data);
    })();
  }, [tag, page]);
  if (!tagData) {
  ...
  const go = (p2) => {
    setPage({ type: "tag", tag, page: p2, url: "/" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Screen, { title: `Tag: ${tag}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total }),
    images.map((img) => /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { img }, img.uuid)),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pager, { page, setPage: go, total })
  ] });
...
function TagsPage() {
  const [tagsData, setTagsData] = reactExports.useState(null);
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getTagsData();
      setTagsData(data);
    })();
  }, []);
  if (!tagsData) {
  ...
  const { tags } = tagsData;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Screen, { title: "Tags", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Buttons, { children: tags.map((t2) => t2.tag).sort().map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TagLink, { onClick: () => setPage({ type: "tag", tag, page: 1, url: "/" }), children: [
    " ",
    tag,
    " "
  ] }, tag)) }) }) }) });
...
const TextEdit = ({ value, onChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "textarea", value, rows: 12, onChange });
};
const Edit = ({ img }) => {
  ...
  const [_2, setPage] = usePageContext();
  const Api2 = useApiContext();
  const [text, setText] = reactExports.useState(img.content.join("\n\n"));
  const [tags, setTags] = reactExports.useState(img.tags);
  const [dialog, setDialog] = reactExports.useState(false);
  const [tag, setTag] = reactExports.useState("");
  reactExports.useEffect(() => {
    (async () => {
      const data = await Api2.getImageData(img.uuid);
      setImageData(data);
    })();
  }, [img]);
  if (!imageData) {
  ...
  const { image } = imageData;
  const handleTextChange = (event2) => setText(event2.target.value);
  const handleTagChange = (event2) => setTag(event2.target.value);
  const saveImage = async () => {
    await Api2.postImageEdit(img.uuid, text, tags);
  ...
  const deleteTag = (tag2) => {
    const newTags = tags.filter((t2) => t2 !== tag2);
    setTags(newTags);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Columns, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ColumnOneThird, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imageSrc, width: "100%" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Column, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextEdit, { value: text, onChange: handleTextChange }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Control, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Buttons, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonLink, { onClick: saveImage, children: " Save " }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonLink, { onClick: addTagDialog, children: " Add Tag " }),
          tags.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Tag, { "data-tag": t2, children: [
            " ",
            t2,
            "  ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "delete ib-delete", onClick: () => deleteTag(t2) }),
            " "
          ] }, t2))
        ] }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: dialog ? "modal is-active" : "modal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-background", onClick: () => setDialog(false) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "box", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "label", children: "Tag:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: tag, type: "text", onChange: handleTagChange }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field is-grouped mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button is-link", onClick: addTag, children: "OK" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button is-light", onClick: () => setDialog(false), children: "Cancel" }) })
        ] })
      ] }) })
    ] })
  ] });
...
function EditPage({ image }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Screen, { title: "Edit Image", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Edit, { img: image }, image.uuid) });
}
function ScreenDispatch() {
  ...
  console.log(page);
  if (page.type === "add") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AddPage, {});
  } else if (page.type === "image") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ImagePage, { uuid: page.uuid });
  } else if (page.type === "new") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(NewPage, { page: page.page });
  } else if (page.type === "draft") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(DraftPage, { page: page.page });
  } else if (page.type === "published") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(PublishedPage, { page: page.page });
  } else if (page.type === "tag") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(TagPage, { tag: page.tag, page: page.page });
  } else if (page.type === "tags") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(TagsPage, {});
  } else if (page.type === "edit") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EditPage, { image: page.image });
  } else {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Screen, { title: "Error", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Unknown page type: ",
      page.type || "null"
    ] }) });
  }
...
function App({ callObj }) {
  const [page, setPage] = reactExports.useState({ type: "published", page: 1, url: "/" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ApiContext.Provider, { value: apiObj, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageContext.Provider, { value: [page, newSetPage], children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScreenDispatch, {}) }) })
  ] });
}
var window_1;
var init;
...
function n(e2) {
  const t2 = window.atob(e2), n2 = t2.length, r2 = new Uint8Array(n2);
...
function o(e2) {
  const t2 = [];
  for (const n2 of e2) {
    const e3 = Array.isArray(n2) ? n2 : [n2];
    for (const n3 of e3) {
      const e4 = n3 instanceof HTMLElement ? n3 : document.getElementById(n3);
      e4 && t2.push(e4);
    }
  }
  return t2;
...
function u() {
  ...
  const r2 = f().split(".")[1], o2 = window.NL_GINJECTED || window.NL_CINJECTED ? "127.0.0.1" : window.location.hostname;
  i = new WebSocket(`ws://${o2}:${window.NL_PORT}?connectToken=${r2}`), function() {
    if (e("ready", async () => {
      if (await l(s), !window.NL_EXTENABLED) return;
      let e2 = await d("extensions.getStats");
      for (let n2 of e2.connected) t("extensionReady", n2);
    }), e("extClientConnect", (e2) => {
      t("extensionReady", e2.detail);
    }), !window.NL_EXTENABLED) return;
    e("extensionReady", async (e2) => {
      e2.detail in c && (await l(c[e2.detail]), delete c[e2.detail]);
    });
  }(), i.addEventListener("message", (e2) => {
    var _a, _b, _c;
    const r3 = JSON.parse(e2.data);
    r3.id && r3.id in a ? (((_a = r3.data) == null ? void 0 : _a.error) ? (a[r3.id].reject(r3.data.error), "NE_RT_INVTOKN" == r3.data.error.code && (i.close(), document.body.innerText = "", document.write("<code>NE_RT_INVTOKN</code>: Neutralinojs application cannot execute native methods since <code>NL_TOKEN</code> is invalid."))) : ((_b = r3.data) == null ? void 0 : _b.success) && a[r3.id].resolve(r3.data.hasOwnProperty("returnValue") ? r3.data.returnValue : r3.data), delete a[r3.id]) : r3.event && ("openedFile" == r3.event && "dataBinary" == ((_c = r3 == null ? void 0 : r3.data) == null ? void 0 : _c.action) && (r3.data.data = n(r3.data.data)), t(r3.event, r3.data));
  }), i.addEventListener("open", async (e2) => {
    t("ready");
  }), i.addEventListener("close", async (e2) => {
    t("serverOffline", { code: "NE_CL_NSEROFF", message: "Neutralino server is offline. Try restarting the application" });
  }), i.addEventListener("error", async (e2) => {
...
function d(e2, t2) {
  return new Promise((n2, r2) => {
    if ((i == null ? void 0 : i.readyState) != WebSocket.OPEN) return o2 = { method: e2, data: t2, resolve: n2, reject: r2 }, void s.push(o2);
    var o2;
    const c2 = "10000000-1000-4000-8000-100000000000".replace(/[018]/g, (e3) => (e3 ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> e3 / 4).toString(16)), u2 = f();
    a[c2] = { resolve: n2, reject: r2 }, i.send(JSON.stringify({ id: c2, method: e2, data: t2, accessToken: u2 }));
  });
}
async function l(e2) {
  for (; e2.length > 0; ) {
    const t2 = e2.shift();
    try {
      const e3 = await d(t2.method, t2.data);
      t2.resolve(e3);
    } catch (e3) {
      t2.reject(e3);
    }
...
function p(e2, t2) {
  return d("os.execCommand", { command: e2, ...t2 });
}
function _(e2, t2) {
  return d("debug.log", { message: e2, type: t2 });
}
function N(e2) {
  return d("app.exit", { code: e2 });
}
var E = Object.freeze({ __proto__: null, broadcast: function(e2, t2) {
  return d("app.broadcast", { event: e2, data: t2 });
}, exit: N, getConfig: function() {
  return d("app.getConfig");
}, killProcess: function() {
  return d("app.killProcess");
}, readProcessInput: function(e2) {
  return d("app.readProcessInput", { readAll: e2 });
}, restartProcess: function(e2) {
  return new Promise(async (t2) => {
    let n2 = window.NL_ARGS.reduce((e3, t3) => (t3.includes(" ") && (t3 = `"${t3}"`), e3 += " " + t3), "");
    (e2 == null ? void 0 : e2.args) && (n2 += " " + e2.args), await p(n2, { background: true }), N(), t2();
  });
}, writeProcessError: function(e2) {
  return d("app.writeProcessError", { data: e2 });
}, writeProcessOutput: function(e2) {
  return d("app.writeProcessOutput", { data: e2 });
} });
const b = /* @__PURE__ */ new Set(), P = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map();
function D(e2 = 0, t2 = 0) {
  return d("window.beginDrag", { screenX: e2, screenY: t2 });
}
function T() {
  return d("window.getSize");
}
var x = Object.freeze({ __proto__: null, beginDrag: D, center: function() {
  return d("window.center");
}, create: function(e2, t2) {
  return new Promise((n2, r2) => {
    function o2(e3) {
      return "string" != typeof e3 || (e3 = e3.trim()).includes(" ") && (e3 = `"${e3}"`), e3;
    }
    t2 = { ...t2, useSavedState: false };
    let i2 = window.NL_ARGS.reduce((e3, t3, n3) => ((t3.includes("--path=") || t3.includes("--debug-mode") || t3.includes("--load-dir-res") || 0 == n3) && (e3 += " " + o2(t3)), e3), "");
    i2 += " --url=" + o2(e2);
    for (let e3 in t2) {
      if ("processArgs" == e3) continue;
      i2 += ` --window${"-" + e3.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}=${o2(t2[e3])}`;
    }
    t2 && t2.processArgs && (i2 += " " + t2.processArgs), p(i2, { background: true }).then((e3) => {
      n2(e3);
    }).catch((e3) => {
      r2(e3);
    });
  ...
  return d("window.exitFullScreen");
}, focus: function() {
  return d("window.focus");
}, getPosition: function() {
  return d("window.getPosition");
}, getSize: T, getTitle: function() {
  return d("window.getTitle");
}, hide: function() {
  return d("window.hide");
}, isFullScreen: function() {
  return d("window.isFullScreen");
}, isMaximized: function() {
  return d("window.isMaximized");
}, isMinimized: function() {
  return d("window.isMinimized");
}, isVisible: function() {
  return d("window.isVisible");
}, maximize: function() {
  return d("window.maximize");
}, minimize: function() {
  return d("window.minimize");
}, move: function(e2, t2) {
  return d("window.move", { x: e2, y: t2 });
}, print: function() {
  return d("window.print");
}, setAlwaysOnTop: function(e2) {
  return d("window.setAlwaysOnTop", { onTop: e2 });
}, setDraggableRegion: function(e2, t2) {
  return new Promise((n2, r2) => {
    var _a;
    const i2 = e2 instanceof HTMLElement ? e2 : document.getElementById(e2);
    if (!i2) return r2({ code: "NE_WD_DOMNOTF", message: "Unable to find DOM element" });
    if (b.has(i2)) return r2({ code: "NE_WD_ALRDREL", message: "This DOM element is already an active draggable region" });
    if ((_a = t2 == null ? void 0 : t2.exclude) == null ? void 0 : _a.length) {
      const e3 = /* @__PURE__ */ new Set();
      for (const n3 of t2.exclude) {
        const t3 = n3 instanceof HTMLElement ? n3 : document.getElementById(n3);
        t3 && e3.add(t3);
      }
      e3.size && P.set(i2, e3);
    }
    const a2 = (s2 = i2, async function(e3) {
      if (0 !== e3.button) return;
      const t3 = P.get(s2);
      if (t3) {
        for (const n3 of t3) if (n3.contains(e3.target)) return;
      }
      await D(e3.screenX, e3.screenY), e3.preventDefault();
    });
    var s2;
    i2.addEventListener("pointerdown", a2), b.add(i2), O.set(i2, a2);
    n2({ success: true, message: "Draggable region was activated", exclusions: { add(...e3) {
      if (!b.has(i2)) throw { code: "NE_WD_NOTDRRE", message: "DOM element is no longer an active draggable region. You likely called unsetDraggableRegion on this element too early!" };
      let t3 = P.get(i2);
      t3 || (t3 = /* @__PURE__ */ new Set(), P.set(i2, t3));
      const n3 = o(e3);
      for (const e4 of n3) t3.add(e4);
    }, remove(...e3) {
      if (!b.has(i2)) throw { code: "NE_WD_NOTDRRE", message: "DOM element is no longer an active draggable region. You likely called unsetDraggableRegion on this element too early!" };
      const t3 = P.get(i2);
      if (!t3) return;
      const n3 = o(e3);
      for (const e4 of n3) t3.delete(e4);
    }, removeAll() {
      if (!b.has(i2)) throw { code: "NE_WD_NOTDRRE", message: "DOM element is no longer an active draggable region. You likely called unsetDraggableRegion on this element too early!" };
      P.delete(i2);
    } } });
  ...
  return d("window.setFullScreen");
}, setIcon: function(e2) {
  return d("window.setIcon", { icon: e2 });
}, setMainMenu: function(e2) {
  return d("window.setMainMenu", e2);
}, setSize: function(e2) {
  return new Promise(async (t2, n2) => {
    let r2 = await T();
    d("window.setSize", e2 = { ...r2, ...e2 }).then((e3) => {
      t2(e3);
    }).catch((e3) => {
      n2(e3);
    });
  ...
  return d("window.setTitle", { title: e2 });
}, show: function() {
  return d("window.show");
}, snapshot: function(e2) {
  return d("window.snapshot", { path: e2 });
}, unmaximize: function() {
  return d("window.unmaximize");
}, unminimize: function() {
  return d("window.unminimize");
}, unsetDraggableRegion: function(e2) {
  return new Promise((t2, n2) => {
    const r2 = e2 instanceof HTMLElement ? e2 : document.getElementById(e2);
    if (!r2) return n2({ code: "NE_WD_DOMNOTF", message: "Unable to find DOM element" });
    if (!b.has(r2)) return n2({ code: "NE_WD_NOTDRRE", message: "DOM element is not an active draggable region" });
    const o2 = O.get(r2);
    o2 && (r2.removeEventListener("pointerdown", o2), O.delete(r2)), b.delete(r2), P.delete(r2), t2({ success: true, message: "Draggable region was deactivated" });
  });
} });
var S = Object.freeze({ __proto__: null, broadcast: function(e2, t2) {
  return d("events.broadcast", { event: e2, data: t2 });
}, dispatch: t, off: function(e2, t2) {
  return window.removeEventListener(e2, t2), Promise.resolve({ success: true, message: "Event listener removed" });
}, on: e });
function L() {
  return d("extensions.getStats");
}
var M = Object.freeze({ __proto__: null, broadcast: function(e2, t2) {
  return d("extensions.broadcast", { event: e2, data: t2 });
}, dispatch: function(e2, t2, n2) {
  return new Promise(async (r2, o2) => {
    const i2 = await L();
    if (i2.loaded.includes(e2)) if (i2.connected.includes(e2)) try {
      r2(await d("extensions.dispatch", { extensionId: e2, event: t2, data: n2 }));
    } catch (e3) {
      o2(e3);
    }
    else !function(e3, t3) {
      e3 in c ? c[e3].push(t3) : c[e3] = [t3];
    }(e2, { method: "extensions.dispatch", data: { extensionId: e2, event: t2, data: n2 }, resolve: r2, reject: o2 });
    else o2({ code: "NE_EX_EXTNOTL", message: `${e2} is not loaded` });
  });
}, getStats: L });
let U = false;
app = E, events = S, extensions = M, init = function(t2 = {}) {
  if (t2 = { exportCustomMethods: true, ...t2 }, !U) {
    if (u(), window.NL_ARGS.find((e2) => "--neu-dev-auto-reload" == e2) && e("neuDev_reloadApp", async () => {
      await _("Reloading the application..."), location.reload();
      ...
      let n2 = {};
      for (const [e3, r2] of t3.entries()) n2 = "object" != typeof r2 || Array.isArray(r2) || null == r2 ? { ...n2, ["arg" + e3]: r2 } : { ...n2, ...r2 };
      return d("custom." + e2, n2);
    };
    window.NL_CVERSION = "6.3.0", window.NL_CCOMMIT = "425c526c318342e0e5d0f17caceef2a53049eda4", U = true;
  }
}, window_1 = x;
  ...
  async call(type, obj) {
    ...
    const response = new Promise((resolve) => {
      const listener = (event2) => {
        const data2 = event2.detail;
        if (data2.callId === callId) {
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, { callObj: NeutralinoCallImpl }) })
);
initialize();
async function initialize() {
  ...
  await window_1.setMainMenu(menu);
  await events.on("mainMenuItemClicked", (evt) => {
    switch (evt.detail.id) {
      case "quit":
        app.exit(0);
      default:
        alert(`Menu option ${evt.detail.id} not implemented`);
    }
  });
}
